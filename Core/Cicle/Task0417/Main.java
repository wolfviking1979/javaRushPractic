...
//        •	Программа должна выводить на экран целое число - результат
//округления введенного целого числа, умноженного на 3.6.
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Введите скорость ветра(km/h)");
        int speed = sc.nextInt();
        int result = (int) Math.round(speed * 3.6);
        System.out.println("Расчет скорости: " + result);
    }
}
