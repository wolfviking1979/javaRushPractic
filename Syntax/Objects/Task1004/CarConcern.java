...
//Если параметр отсутствует, то нужно инициализировать поле значением по умолчанию. Для поля
//year это текущий год (4321), для поля color — Оранжевый.
//
//        Требования:
